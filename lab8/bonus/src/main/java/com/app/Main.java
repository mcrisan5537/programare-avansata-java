...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // await connection pool to be created
        Thread.sleep(1500);
        useConnectionPool();
    ...
    public static void useConnectionPool() throws Exception {
        ...
        System.out.println("ConnectionPool time: " + (timeEnd - timeStart)/1000 + " seconds.");

    }

    public static void useSingletonConnection() throws Exception {

        ThreadPoolExecutor threadPoolExecutor = (ThreadPoolExecutor) Executors.newFixedThreadPool(6);

        Long timeStart = System.currentTimeMillis();
        for(int i = 0; i < 350; i++) {
            Runnable runnable = new SQLOperation(false);
            threadPoolExecutor.execute(runnable);
        }
        ...
        System.out.println("SingletonConnection time: " + (timeEnd - timeStart)/1000 + " seconds.");
